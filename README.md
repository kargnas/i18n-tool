...
- Linux 와 Mac에서 테스트되었습니다. 아래 설명은 우분투 기준입니다.
  - 참고: Mac 의 경우 OS 버전별로 아파치와 PHP 연동 설정이 약간씩 다릅니다. 그러므로 PHP 웹서버 세팅 숙련자가 아니라면 맥에서의 세팅은 조금 힘들 수 있으므로, 우분투 서버에서 테스트하기를 권장합니다.
...
- bower 을 설치하기 위해서는 NodeJS와 NPM을 먼저 설치해야 하니, 아래와 같이 설치합니다.
...
세팅이 완료되었습니다. http://i18n.example.com 을 접속해보시면 됩니다.
